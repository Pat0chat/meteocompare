 ...
 * Depuis l'ajout des variantes de taille (10 receivers coexistants), les
...
class MeteoWidgetReceiverTest {
    ...
    @Test
    fun `anyAliveWith - scanne LES 10 receivers du registry, aucun ne doit être zappé`() {
    ...
    fun `anyAliveWith - court-circuite dès qu'un receiver vivant est trouvé`() {
        ...
        // true. Sur un utilisateur avec 10 widgets, on ne veut PAS interroger
